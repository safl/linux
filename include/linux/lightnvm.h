...
typedef int (nvmm_erase_list_fn)(struct nvm_dev *, struct ppa_addr *, int, int);
...
extern int nvm_erase_list(struct nvm_dev *, struct ppa_addr *, int, int);
